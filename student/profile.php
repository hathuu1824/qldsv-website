        ...
        <div class="profile-info">
            ...
            <div class="profile-content">
                <div class="profile-row">
                    ...
                    <p><strong>Mã sinh viên:</strong> <?php echo htmlspecialchars($code); ?></p>
                </div>
                <div class="profile-row">
                ...
                <div class="profile-row">
                    <p><strong>Khóa ngành đào tạo:</strong> <?php echo htmlspecialchars($year); ?> - <?php echo htmlspecialchars($faculty); ?></p>
                </div>
                <div class="profile-row">
                    <p><strong>Chuyên ngành:</strong> <?php echo htmlspecialchars($major); ?></p>
                </div>
                <div class="profile-row">
