...
<body>
    <div class="header">
        ...
        <div id="userPopup" class="popup user-popup">
            <a href="../student/profile.php">Thông tin cá nhân</a>
            <a href="../student/classes.php">Lớp học</a>
    ...
    <div class="sidebar">
        <ul>
            <li><a href="../student/home.php">Trang chủ</a></li>
            <li><a href="../student/profile.php">Thông tin cá nhân</a></li>
            <li><a href="../student/progress.php">Tiến trình học tập</a></li>
            <li><a href="../student/class.php">Lớp học</a></li>
            <li><a href="../student/calendar.php">Lịch & Sự kiện</a></li>
            <li><a href="../student/scores.php">Kết quả học tập</a></li>
            <li><a href="../student/grade_request.php">Đăng ký phúc khảo</a></li>
            <li><a href="../student/major_request.php">Đăng ký chuyên ngành</a></li>
        </ul>
    </div>
