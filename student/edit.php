        ...
        <form action="edit.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="profile-info">
                ...
                <div class="profile-content">
                    ...
                    <div class="profile-row">
                        <p><strong>Mã sinh viên:</strong> <input type="text" value="<?php echo htmlspecialchars($code); ?>" disabled class="readonly-input" style="background: #eee; cursor: not-allowed;"></p>
                    ...
                    <div class="warning-text" style="color: #e67e22; font-style: italic; font-size: 13px; margin-top: 10px;">
                        * Lớp, Khoa, Chuyên ngành do quản trị viên cập nhật.
                    </div>
                </div>
            </div>
        </form>
